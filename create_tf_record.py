...
def get_class_name_from_object(object):
  """Gets the class name from an object.

  Args:
    object: The file name to get the class name from.
               ie. "american_pit_bull_terrier_105.jpg"
...
def dict_to_tf_example(data,
  ...
  if 'object' in data:
    for obj in data['object']:
      ...
      class_name = get_class_name_from_object(data['object'])
